...
const About = ({setplayState}) => {
  return (
    ...
    <div className="about-right">
        ...
        <p>Whether you aspire to become a teacher, administrator, counselor, or educational leader, our divers range of programs offers the perfect pathway to achieve your goals and unlock your full potential in shaping the future of education</p>
